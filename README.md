...
***(1 mark)*** __Files: 7 and Folders: 1__.
...
***(1 mark)*** __2-Core, 8GB RAM, 32GB and 4-Core, 16GB RAM, 32GB__.
3. Why must we commit and sync our current work on source control?
***(1 mark)*** __To save into the main repository when you submit your project__.
